...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        // Deliberately use the SAME exception/message whether the email doesn't
        // exist or the password is wrong - telling the caller which one it was
        ...
        // Each user has exactly one Role in this model, so exactly one authority.
